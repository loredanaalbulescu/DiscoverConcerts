...
class BandsControllerTest < ActionController::TestCase
  ...
  test "should create band" do
    assert_difference('Band.count') do
      post :create, band: { city: @band.city, description: @band.description, fb_id: @band.fb_id, genre: @band.genre, name: @band.name }
    end
  ...
  test "should update band" do
    put :update, id: @band, band: { city: @band.city, description: @band.description, fb_id: @band.fb_id, genre: @band.genre, name: @band.name }
    assert_redirected_to band_path(assigns(:band))
  end
