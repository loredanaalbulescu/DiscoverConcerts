...
class ConcertsControllerTest < ActionController::TestCase
  ...
  test "should create concert" do
    assert_difference('Concert.count') do
      post :create, concert: { city: @concert.city, date_time: @concert.date_time, description: @concert.description, location: @concert.location, name: @concert.name, price: @concert.price }
    end
  ...
  test "should update concert" do
    put :update, id: @concert, concert: { city: @concert.city, date_time: @concert.date_time, description: @concert.description, location: @concert.location, name: @concert.name, price: @concert.price }
    assert_redirected_to concert_path(assigns(:concert))
  end
